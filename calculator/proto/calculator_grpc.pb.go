...
func (c *calculatorServiceClient) CalculateAvg(ctx context.Context, opts ...grpc.CallOption) (CalculatorService_CalculateAvgClient, error) {
	stream, err := c.cc.NewStream(ctx, &CalculatorService_ServiceDesc.Streams[0], "/calculator.CalculatorService/CalculateAvg", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *calculatorServiceCalculateAvgClient) Send(m *AvgRequest) error {
...
func (x *calculatorServiceCalculateAvgServer) Recv() (*AvgRequest, error) {
	m := new(AvgRequest)
